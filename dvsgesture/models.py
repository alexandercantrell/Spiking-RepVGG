...
def SEWRepVGG(num_classes, cnf):
    layer_list = [
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'sew', 'k_pool': 2},
...
def QASEWRepVGG(num_classes, cnf):
    layer_list = [
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 2, 'block': 'qasew', 'k_pool': 2},
...
def SEWRepVGGH(num_classes, cnf):
    layer_list = [
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'sew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'sew', 'k_pool': 2},
...
def QASEWRepVGGH(num_classes, cnf):
    layer_list = [
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'qasew', 'k_pool': 2},
        {'channels': 32, 'out_channels': 32, 'num_blocks': 1, 'block': 'qasew', 'k_pool': 2},
