# --------------------------------------------------------
# RepVGG: Making VGG-style ConvNets Great Again (https://openaccess.thecvf.com/content/CVPR2021/papers/Ding_IDQASpikingRepVGG_Making_VGG-Style_ConvNets_Great_Again_CVPR_2021_paper.pdf)
...
class IDQASpikingRepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_checkpoint=False, cnf=None, spiking_neuron=None, zero_init_residual=True, **kwargs):
        ...
        self.stage0 = IDQASpikingRepVGGBlock(in_channels=3, out_channels=self.in_planes, kernel_size=3, stride=2, padding=1, deploy=self.deploy, spiking_neuron=spiking_neuron, **kwargs)
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, IDQASpikingRepVGGBlock) and m.cnf is not None:
    ...
    def _make_stage(self, planes, num_blocks, stride, cnf, spiking_neuron, **kwargs):
        ...
        for stride in strides:
            ...
            blocks.append(IDQASpikingRepVGGBlock(in_channels=self.in_planes, out_channels=planes, kernel_size=3,
...
def create_IDQASpikingRepVGG_A0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_A1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_A2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint,cnf=cnf,spiking_neuron=spiking_neuron,**kwargs)

def create_IDQASpikingRepVGG_B1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B1g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B1g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B2g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B2g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B3(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B3g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_B3g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_IDQASpikingRepVGG_D2se(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return IDQASpikingRepVGG(num_blocks=[8, 14, 24, 1], num_classes=num_classes,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint,cnf=cnf,spiking_neuron=spiking_neuron,**kwargs)


func_dict = {
'IDQASpikingRepVGG-A0': create_IDQASpikingRepVGG_A0,
'IDQASpikingRepVGG-A1': create_IDQASpikingRepVGG_A1,
'IDQASpikingRepVGG-A2': create_IDQASpikingRepVGG_A2,
'IDQASpikingRepVGG-B0': create_IDQASpikingRepVGG_B0,
'IDQASpikingRepVGG-B1': create_IDQASpikingRepVGG_B1,
'IDQASpikingRepVGG-B1g2': create_IDQASpikingRepVGG_B1g2,
'IDQASpikingRepVGG-B1g4': create_IDQASpikingRepVGG_B1g4,
'IDQASpikingRepVGG-B2': create_IDQASpikingRepVGG_B2,
'IDQASpikingRepVGG-B2g2': create_IDQASpikingRepVGG_B2g2,
'IDQASpikingRepVGG-B2g4': create_IDQASpikingRepVGG_B2g4,
'IDQASpikingRepVGG-B3': create_IDQASpikingRepVGG_B3,
'IDQASpikingRepVGG-B3g2': create_IDQASpikingRepVGG_B3g2,
'IDQASpikingRepVGG-B3g4': create_IDQASpikingRepVGG_B3g4,
'IDQASpikingRepVGG-D2se': create_IDQASpikingRepVGG_D2se,      #   Updated at April 25, 2021. This is not reported in the CVPR paper.
}
def get_IDQASpikingRepVGG_func_by_name(name):
