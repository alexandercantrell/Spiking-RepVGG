...
class StaticSpikingRepVGGBlock(nn.Module):
    ...
    def forward(self, inputs):
        if hasattr(self, 'rbr_reparam'):
            out = self.sn.single_step_forward(self.rbr_reparam(inputs))
        else:
            out = self.sn.single_step_forward(self.rbr_dense(inputs) + self.rbr_1x1(inputs))
...
class StaticSpikingRepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_checkpoint=False, cnf=None, spiking_neuron=None, **kwargs):
        ...
        self.stage0 = StaticSpikingRepVGGBlock(in_channels=3, out_channels=self.in_planes, kernel_size=3, stride=2, padding=1, deploy=self.deploy, spiking_neuron=self.sn0)
...
def create_StaticSpikingRepVGG_A0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_A1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_A2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint,cnf=cnf,spiking_neuron=spiking_neuron,**kwargs)

def create_StaticSpikingRepVGG_B1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B1g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B1g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B3(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B3g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_B3g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_StaticSpikingRepVGG_D2se(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return StaticSpikingRepVGG(num_blocks=[8, 14, 24, 1], num_classes=num_classes,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint,cnf=cnf,spiking_neuron=spiking_neuron,**kwargs)
