...
class HybridSpikingRepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_checkpoint=False, cnf=None, spiking_neuron=None, zero_init_residual=True, **kwargs):
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, HybridSpikingRepVGGBlock) and m.cnf is not None:
...
def create_HybridSpikingRepVGG_A0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_A1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_A2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B0(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint,cnf=cnf,spiking_neuron=spiking_neuron,**kwargs)

def create_HybridSpikingRepVGG_B1(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B1g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B1g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B2g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B2g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B3(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B3g2(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
...
def create_HybridSpikingRepVGG_B3g4(num_classes=1000, deploy=False, use_checkpoint=False,cnf=None,spiking_neuron=None,**kwargs):
    return HybridSpikingRepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
